...
# YOLO_MODEL_PATH = r"best(2).pt"  # ตำแหน่งไฟล์โมเดล YOLO -> สำหรับ Production (ให้เปลี่ยนเป็น yolo11l.pt ตอนใช้งานจริง)
...
TARGET_CLASS_NAME = ''    # ชื่อคลาสของวัตถุเป้าหมายที่ต้องการตรวจจับ -> สำหรับ Development (ให้เปลี่ยนเป็น basketball_hoop ตอนใช้งานจริง)
...
VIDEO_FILE_PATH = r"C:\\Users\\bpbea\\Documents\\GitHub\\FIBOXVISION2025\\src\\video\\color_output.mp4" # <<< หากทดสอบเป็น Video (แก้ Path ตามต้องการ)
